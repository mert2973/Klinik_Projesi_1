...
@section('icerik')
        ...
        <div class="page-body">
            ...
            <div class="page-title">
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <h2 class="page-title-text d-inline-block">Randevu Yönetimi</h2>
                        <div class="breadcrumbs">
                            <ul>
                               ...
                               <span class="text-linkedin ml-2"> <a href="{{url('/Appointments')}}">Randevular</a></span>
                                ...
                                <span class="ml-2">Randevu Yönetimi</span>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <ul class="nav nav-tabs nav-tabs-line nav-tabs-line-primary">
                            ...
                            <li class="nav-item">
                                <a class="nav-link prc_click"  href="#appointment-hzm" data-toggle="tab">Yapılan İşlemler</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content pt-4">
                                        ...
                                        <div class="apnt-user-input">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control apnt-name text-capitalize" name="patient_name" readonly value="{{$dr_with_patient->p_name}} {{$dr_with_patient->p_surname}}" placeholder="Hasta adını giriniz . . ." required="">
                                                    <input type="hidden" name="patient_id" value="{{$dr_with_patient->patients_id}}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                            ...
                            <div class="tab-pane" id="appointment-hzm">
                                   <div class="row " >
                                        ...
                                        <div class="table-responsive" style="min-height: 100%" >
                                            <table class="table table-bordered medicine-table " >
                                                <thead>
                                                <tr class="">
                                                    <th style="width: 15%;">İşlem Adı</th>
                                                    <th style="width: 10%;">Adet</th>
                                                    <th style="width: 21%;">Açıklama</th>
                                                    <th style="width: 23%;">Dişler</th>
                                                    <th style="width: 5%;"></th>
                                                </tr>
                                                </thead>
                                                <tbody class="tooth-row-hzm">
                                                @php  $say=0; @endphp
                                                @foreach($teeth_processes as $itm)
                                                   
                                                    <tr class="">
                                                        <input type="hidden" name="tooth_record[{{$say}}][id]" value="{{$itm->id}}">
                                                        <td>
                                                            <input class="form-control proceses_name prc_num{{$say}}" name=tooth_record[{{$say}}][name]" value="{{$itm->prc_name}}" @if($itm->control_invoice!=0) {{"Readonly"}} data-toggle="tooltip" title="Faturalandırılmıştır" @endif @ placeholder="İşlem adı">
                                                            <input type="hidden" class="itm_id"  name=tooth_record[{{$say}}][itm_id]" required value="{{$itm->itm_id}}">
                                                            <input type="hidden" class="itm_type"  name=tooth_record[{{$say}}][type]" required value="{{$itm->itm_type}}">
                                                        </td>
                                                        <td>
                                                            <input type="number" class="form-control " name=tooth_record[{{$say}}][piece]" value="{{$itm->piece}}" @if($itm->control_invoice!=0) {{"Readonly"}} data-toggle="tooltip" title="Faturalandırılmıştır" @endif   placeholder="Adet">
                                                            <input type="hidden" name=tooth_record_backup[{{$say}}][piece]" value="{{$itm->piece}}">
                                                        </td>
                                                        <td>
                                                            <textarea class="form-control " name=tooth_record[{{$say}}][exp]" @if($itm->control_invoice!=0) {{"Readonly"}} data-toggle="tooltip" title="Faturalandırılmıştır" @endif rows="1" placeholder="Adet">{{$itm->exp_prc}}</textarea>
                                                        </td>
                                                        <td>
                                                            <input type="text" data-role="tagsinput" class="form-control teeth_num   tooth_input{{$say}}"   name="tooth_record[{{$say}}][tooth]"
                                                                   value="{{$itm->teeth_num}}"  placeholder="D ile başlayan 1-32 arası Diş Numarası Giriniz"  @if($itm->control_invoice!=0) {{"Disabled"}} data-toggle="tooltip" title="Faturalandırılmıştır" @endif >
                                                         
                                                           <!-- <input type="text" name="deneme" class="form-control proceses_name" data-role="tagsinput" > -->
                                                        </td>
                                                        <td><button class="table-action-button last_line medicine-delete" value="{{$say}}" style="display: none;" @if($itm->control_invoice!=0) {{"Disabled"}} data-toggle="tooltip" title="Faturalandırılmıştır" @endif
                                                                    id="del_row<?php del_row_fnc(1); ?>"><i class="ti-trash text-danger"></i></button></td>
                                                    </tr>
                                                    @php $say+=1; @endphp
                                                @endforeach
                                                ...
                                                <tr>
                                                    <td colspan="3">
                                                        <a id="add-hzm" class="font-12 text-primary cursor-pointer">Yeni Bir İşlem Ekle</a>
                                                    </td>
                                                    <td colspan="2">
                                                        <span class="warning1 alert-warning"></span>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
                                ...
                                <div class="row clinical-notes">
                                    <div class="col-lg-4">
                                        <div class="notes-form">
                                            ...
                                            <div class="form-group">
                                                <label>Hizmetler/Ürünler</label>
                                                <div class="input-group">
                                                    <input type="text" class="form-control ui-autocomplete-input" data-name="items" placeholder="Hizmet adını giriniz.. . . ." autocomplete="off">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="notes-container">
                                            <div class="timeline-1 timeline-2">
                                                ...
                                                <div class="item item-left notes-items">
                                                    <div class="circle"><i class="ti-write text-primary"></i></div>
                                                    <div class="arrow"></div>
                                                    <div class="item-content">
                                                        <div class="title">Hizmetler/Ürünler</div>
                                                        <div class="descr">
                                                            <ul>
                                                                @foreach($notes_advices as $note_id=>$note)
                                                                    <li> {{$note}} <input type="hidden" name="items[{{$note_id}}]" value="{{$note}}">
                                                                        <span class="ti-close delete"></span>
                                                                    </li>
                                                                @endforeach
                                                            </ul>
   ...
   <script>
       ...
       $(document).ready(function () {
           $('#add-hzm').click(function () {
               ...
               $(".tooth-row-hzm:last").after('<tr class="tooth-row-hzm">' +
                   '<td><input class="form-control proceses_name prc_num' + count + '" name="teeth[tooth][' + count + '][name]" value="" placeholder="İşlem adı" required><input type="hidden" class="itm_id" name="teeth[tooth][' + count + '][itm_id]"></td>' +
                   '<td><input type="number" class="form-control " name="teeth[tooth][' + count + '][piece]" value="" placeholder="Adet" required></td>' +
                   '<input type="hidden" class="itm_type"  name="teeth[tooth]['+ count +'][type]" required value="">' +
                   '<td><textarea class="form-control " name="teeth[tooth][' + count + '][exp]" rows="2" cols="5" placeholder="Açıklama" required></textarea></td>' +
                   '<td > <input type="text" value="" name="teeth[tooth][' + count + '][tooth]" data-role="tagsinput" class="form-control teeth_num tooth_input' + count + '"  placeholder="D ile başlayan 1-32 arası Diş Numarası Giriniz" > </td>' +
                   '<td><button value="'+count+'" class="table-action-button last_line tooth-delete delete_row'+ count +'" ><i class="ti-trash text-danger" ></i></button></td>' +
                   '</tr>');
             
               $(".delete_row"+count).click(function () {
                   var the_del_row0=$(this).val();
                   for(var i=0;i<all_ind.length;i++){
                       if(all_ind[i]==the_del_row0){
                          // alert("Silinen:"+all_ind[i]);
                           all_ind.splice(i,1);//del the ind num from array
                       }
                   }
               });
               all_ind.push(count);
       ...
       /*****For exist line **/
       $(document).ready(function () {
           var total_row="@php echo $say; @endphp";
           var del="@php function del_row_fnc($id){ return $id; } @endphp";
         
           for(var t=0;t<total_row;t++){
               all_ind.push(t);
           }
           
           $("#chk_something").click(function () {
               $(".warning1").html(all_ind);
             
           });
           
           $("#del_row,del").click(function (){
               var the_del_row=$(this).val();
              for(var i=0;i<all_ind.length;i++){
                  if(all_ind[i]==the_del_row){
                     // alert("Silinen:"+all_ind[i]);
                      all_ind.splice(i,1);//del the ind num from array
                  }
               }
           ...
           /** --- when click tab of "yapılan işlemler", sign all teeth on grafical**/
           $(".prc_click").click(function () {
               for(var d=1;d<=32;d++){
                   $("#Tooth"+d).css("fill","ffffff");
               }
               for(var r=0;r<=all_ind.length;r++){
                   var each_row= $('.tooth_input'+all_ind[r]).tagsinput('items');//in each row have items (D1,...)
                  
                   for(var p=0;p<each_row.length;p++){
                       // alert(each_row[p]);
                       var process_name=  $(".prc_num"+all_ind[r]).val();
                       if(process_name=="Köprü"){
                           var  tooth_number=each_row[p].slice(1);
                           $("#Tooth"+tooth_number).css("fill","red");
                       }else{
                           var  tooth_number=each_row[p].slice(1);
                           $("#Tooth"+tooth_number).css("fill","e8ea54");
                       }
                   }
               }
           });
           /** ---End.when click "yapılan işlemler" **/
           $("body").click(function () {
              $(".prc_click").click();
           });
       });
   ...
   <script type="text/javascript" src="{{asset('css_js_img/prescription.js')}}"></script>
   <script type="text/javascript" src="{{asset('css_js_img/teeth.js')}}"></script>
   
   <!--add tags to input-->
   <!--End.add tags to input-->
 
   <!---  typhead (multi value of tags in textbox) ---->
    <script src="{{asset('css_js_img/typehead/assets/app.js')}}"></script>
    <script src="{{asset('css_js_img/typehead/typehead.boundle.js')}}"></script>
   <script src="{{asset('css_js_img/typehead/dist/bootstrap-tagsinput.min.js')}}"></script>
   <!---End. typhead (multi value of tags in textbox) ---->
