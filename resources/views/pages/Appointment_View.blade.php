        ...
        <div class="row">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="user-details text-center pt-3">
                            ...
                            <ul class="v-menu text-left pt-0 nav d-block">
                                ...
                                <li><a href="#appointment-process" data-toggle="tab"><i class="ti-calendar"></i> <span>Yapılan İşlemler</span></a></li>
                                ...
                                <li><a href="{{route('Appointments.edit',$dr_with_ptn->id)}}"><i class="ti-pencil-alt"></i> <span>Randevu Yönetimi</span></a></li>
            ...
            <div class="col-md-8 pl-0">
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="appointment-process">
                        <div class="panel panel-default">
                            <div class="panel-head ">
                                <div class="row">
                                        <div class="panel-title pl-10">Yapılan İşlemler</div>
                                </div>
                            </div>
                                            ...
                                            <div class="timeline-1 timeline-2">
                                                <div class="marker"></div>
                                                    <div class="item item-left pt-0">
                                                        ...
                                                        <div class="arrow"></div>
                                                                <div class="item-content">
                                                                    <div class="time col-lg-12 " style="left:0px">Dr. {{$dr_with_ptn->name}} {{$dr_with_ptn->surname}}  <span class="float-right"><span class="date_title_muted">Randevu Tarihi:</span> {{$date}}</span></div>
                                                                    <div class="table-responsive pt-3" >
                                                                        ...
                                                                        <table class="table table-bordered ">
                                                                            ...
                                                                            @php $teeth=[]; @endphp
                                                                            @foreach($teeth_processes as $all_teeth)
                                                                                <tr>
                                                                                    <td>
                                                                    ...
                                                                    <div class="text-secondary  text-right pt-3">
