        ...
        <div class="page-body">
            <div class="page-title">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h2 class="page-title-text d-inline-block">Kasa İşlemlerini İncele </h2>
                        <div class="breadcrumbs d-inline-block">
                            <ul>
                                <li><a href="{{url('Dashboard')}}">Dashboard</a></li>
                                <li><a href="{{route('Casing.index')}}">Kasalar</a></li>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="user-avtar" >
                                <span style="height: 79px;width: 80px;line-height: 78px;">{{$casing->currency}}</span>
                            </div>
                            <div class="user-details text-center pt-3">
                                <h3> {{$casing->service_name."/".$casing->branch_name}}</h3>
                                <ul class="v-menu text-left pt-3 nav d-block">
                                    <li><a href="#medicine-info" class="active" data-toggle="tab"><i class="ti-info-alt"></i> <span>Hesap Bilgileri</span></a></li>
                                    <li><a href="#medicine-stock" data-toggle="tab"><i class="ti-archive"></i> <span>Hesap İşlemleri</span></a></li>
                                    <li><a href="#medicine-badstock" data-toggle="tab"><i class="ti-files"></i> <span>Tab 3</span></a></li>
                        ...
                        <div class="tab-pane fade show active" id="medicine-info">
                            <div class="panel panel-default">
                                <div class="panel-head">
                                    <div class="panel-title"> Hesap İşlemleri</div>
                                </div>
                                <div class="panel-body">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <table class="table table-middle table-bordered table-striped " id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                                        <thead>
                                                        <tr role="row">
                                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="#: activate to sort column ascending" style="width: 5%;">#</th>
                                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Batch: activate to sort column ascending" style="width: 90px;">Tarih</th>
                                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="#: activate to sort column ascending" style="width: 10%;">Açıklama</th>
                                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Expiry: activate to sort column ascending" style="width: 90px;">Hesap Adı</th>
                                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Purchase Price: activate to sort column ascending" style="width: 60px;">Borç</th>
                                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Purchase Price: activate to sort column ascending" style="width: 60px;">Alacak</th>
                                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Sale Price: activate to sort column ascending" style="width: 60px;"><span class="pt-0 ">Bakiye</span><br><span class="font-weight-light">{{$casing->first_balance." ".$casing->currency}} </span></th>
                                                            <!-- <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Qty: activate to sort column ascending" style="width: 0px;">Qty</th>
                                                             <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Sold: activate to sort column ascending" style="width: 0px;">Sold</th>
                                                             <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Live Stock: activate to sort column ascending" style="width: 0px;">Live Stock</th> -->
                                                        ...
                                                        <tbody>
                                                        @php $say=1; @endphp
                                                        @foreach($proceses_of_accounts as $list)
                                                            @php $date= Carbon\Carbon::parse($list->paid_date)->format("d/m/Y H:i"); @endphp
                                                        <tr role="row" class="odd">
                                                            <td>{{$say++}}</td>
                                                            <td class="expiry text-danger p-2">{{$date}}</td>
                                                            @if($list->inv_id<10 && $list->type_inv=="purchase")
                                                                <td class="expiry text-primary p-2">{{"AF-000".$list->inv_id}}</td>
                                                            @elseif($list->inv_id<100 && $list->type_inv=="purchase")
                                                                <td class="expiry text-primary p-2">{{"AF-00".$list->inv_id}}</td>
                                                            @elseif($list->inv_id<1000 && $list->type_inv=="purchase")
                                                                <td class="expiry text-primary p-2">{{"AF-0".$list->inv_id}}</td>
                                                            @elseif($list->type_inv=="purchase" && ($list->inv_id>=10000 || $list->inv_sale_id<=10000))
                                                                <td class="expiry text-primary p-2">{{"AF-".$list->inv_id}}</td>
                                                                
                                                            @elseif($list->inv_id<10 && $list->type_inv=="sale")
                                                                <td class="expiry text-primary p-2">{{"SF-000".$list->inv_id}}</td>
                                                            @elseif($list->inv_id<100 && $list->type_inv=="sale")
                                                                <td class="expiry text-primary p-2">{{"SF-00".$list->inv_id}}</td>
                                                            @elseif($list->inv_id<1000 && $list->type_inv=="sale")
                                                                <td class="expiry text-primary p-2">{{"SF-0".$list->inv_id}}</td>
                                                            @elseif( $list->type_inv=="sale" && ($list->inv_id>=10000  || $list->inv_sale_id<=10000))
                                                                <td class="expiry text-primary p-2">{{"SF-".$list->inv_id}}</td>
                                                            @endif
                                                            
                                                            <td class="batch text-primary">{{$list->names}}</td>
                                                            <td>{{$list->debt." ".$casing->currency}}</td>
                                                            <td>{{$list->credit." ".$casing->currency}}</td>
                                                            <td class="qty">{{$list->last_cash_balance." ".$casing->currency}}</td>
                                                       ...
                                                       @endforeach
                                                        ...
                                                        <!--  <th rowspan="1" colspan="1"></th>
                                                            <th rowspan="1" colspan="1"></th>
                                                            <th rowspan="1" colspan="1"></th>
                                                            <th rowspan="1" colspan="1">{{--$casing->last_cash_balance." ".$casing->currency--}}</th>
                                                            <th rowspan="1" colspan="1">.. TL</th>
                                                            <th rowspan="1" colspan="1"></th>
                                                           <th rowspan="1" colspan="1"></th> -->
                                                        </tr>
                                                        </tfoot>
