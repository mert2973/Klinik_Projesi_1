...
@section('icerik')
    ...
    <div class="page-wrapper">
        <div class="page-body">
                                                        ...
                                                        <div class="fc-content-skeleton">
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="fc-day-top fc-tue fc-other-month fc-past" data-date="2020-01-28"><span class="fc-day-number">28</span></td>
                                                                    <td class="fc-day-top fc-wed fc-other-month fc-past" data-date="2020-01-29"><span class="fc-day-number">29</span></td>
                                                                    <td class="fc-day-top fc-thu fc-other-month fc-past" data-date="2020-01-30"><span class="fc-day-number">30</span></td>
                                                                    <td class="fc-day-top fc-fri fc-other-month fc-past" data-date="2020-01-31"><span class="fc-day-number">31</span></td>
                                                                    <td class="fc-day-top fc-sat fc-past" data-date="2020-02-01"><span class="fc-day-number">1</span></td>
                                                                </tr>
                                                                </thead>
                                                                <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td class="fc-event-container">
                                                                        <a class="fc-day-grid-event fc-h-event fc-event fc-start fc-end fc-event-warning fc-event-solid-warning fc-event-gradient">
                                                                            <div class="fc-content"><span class="fc-time">10:30a</span> <span class="fc-title">PepDev Team</span></div>
                                                                        </a>
                                                                    </td>
                                                                    <td></td>
                                                                </tr>
                                            ...
                                            <div class="dataTables_paginate paging_full_numbers" id="DataTables_Table_0_paginate">
                                                <ul class="pagination">
                                                    ...
                                                    <li class="paginate_button page-item previous disabled" id="DataTables_Table_0_previous">
                                                        <a href="#" aria-controls="DataTables_Table_0" data-dt-idx="1" tabindex="0" class="page-link"><i class="fa fa-angle-left"></i>
                                                        </a>
                                                    </li>
            ...
            <!-- Takvim sidebar for updateing-->
            <div class="sidebar sidebar-right appointmet-sidebar">
                <div class="sidebar-hdr">
                    <div class="sidebar-close"><i class="ti-close"></i></div>
                    <h3 class="title">Randevu</h3>
                </div>
                
                <form class="sidebar-bdy" action="" method="post"  id="apt_sidebar_form"><!--  siq_id="autopick_5117" --->
                   @csrf
                    @method('PUT')
                    <div id="apnt-info">
                        <input type="hidden" class="apnt-id" name="apnt_id">
                        <div class="form-group mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="name" class="form-control patient_name ui-autocomplete-input" placeholder="Hasta adını giriniz . . ." readonly required="" autocomplete="off">
                                <input type="text" name="surname" class="form-control patient_surname ui-autocomplete-input" placeholder="Soyadı giriniz . . ." readonly required="" autocomplete="off">
                        ...
                        <div class="form-group mb-2">
                            <label>Hasta Email Adresi.. <span class="form-required">*</span></label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="ti-timer"></i></span>
                                </div>
                                <input type="text" name="email" class="form-control patient-mail" placeholder="Email adresi giriniz . . ." readonly required="">
                            </div>
                        </div>
                        <div class="form-group mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="phone" class="form-control patient-mobile" placeholder="Telefon numarasını giriniz . . ." readonly required="">
                            </div>
                        </div>
                        <div class="form-group mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <input type="hidden" name="prev_doctor" value="" class="apnt-doctor">
                                <select class="form-control" name="doctor" id="lst_dr" required>
                        ...
                        <div class="form-group mb-2">
                            ...
                            <div class="input-group">
                               ...
                               <input type="hidden" value="" name="prev_date" class="apnt-date">
                                <input type="text" name="apt_date" class="form-control apnt-date"  value="" placeholder="Randevu tarihini seçiniz . . ." required="" autocomplete="off" id="datepicker">
                            </div>
                        </div>
                        <div class="form-group mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <input type="hidden" class="apnt-time" name="prev_time">
                                <input type="time" name="apt_time" class="form-control apnt-time" value="" required="" >
            ...
            <!--End. Takvim sidebar -->
            <!-- Takvim sidebar for creating-->
            <div class="sidebar sidebar-right appointmet-sidebar_create">
                <div class="sidebar-hdr">
                    <div class="sidebar-close"><i class="ti-close"></i></div>
                    <h3 class="title">Randevu Oluştur</h3>
                </div>
                <form class="sidebar-bdy" action="{{route('Appointments.store')}}" method="post"><!--  siq_id="autopick_5117" --->
                    @csrf
                    <div id="apnt-info">
                        <input type="hidden" class="apnt-id" name="apnt_id">
                        <div class="form-group mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="name" class="form-control  ui-autocomplete-input" placeholder="Hasta adını giriniz . . ." required="" autocomplete="off"  id="name">
                                <input type="text" name="surname" class="form-control  ui-autocomplete-input" placeholder="Soyadı giriniz . . ." required="" autocomplete="off" id="surname">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="email" class="form-control" placeholder="Email adresi giriniz . . ." required="" id="email">
                            </div>
                        </div>
                        <div class="form-group mb-2">
                            <label>Hasta Telefon Numarası. <span class="form-required">*</span></label>
                            <div class="input-group">
                                ...
                                <input type="text" name="phone" class="form-control " placeholder="Telefon numarasını giriniz . . ." required="" id="phone">
                            </div>
                        </div>
                        <div class="form-group mb-2">
                            <label>Doktor <span class="form-required">*</span></label>
                            <div class="input-group">
                                ...
                                <select class="form-control lst_dr" name="doctor"  required>
                        ...
                        <div class="form-group mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="apt_date" class="form-control datepicker" value="" placeholder="Randevu tarihini seçiniz . . ." required="" autocomplete="off" >
                            </div>
                        </div>
                        <div class="form-group mb-2">
                            <label>Saat <span class="form-required">*</span></label>
                            <div class="input-group">
                                ...
                                <input type="time" name="apt_time" class="form-control" value="" required="" >
                                <!-- <input type="hidden" name="appointment[slot]" class="apnt-slot-time" value="" required=""> -->
                            </div>
                            <div class="apnt-slot"></div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <select name="apt_status" class="custom-select" required="">
                                    <option value="İşleniyor">İşleniyor</option>
                                    <option value="Doğrulandı">Doğrulandı</option>
                                    <option value="Tamamlandı">Tamamlandı</option>
                                    <option value="İptal Edildi">İptal Edildi</option>
                    ...
                    <div class="sidebar-ftr text-left">
                        <!-- <a href="#" class="btn btn-default"></a> -->
                        <button type="submit" name="submit" class="btn btn-primary">Yeni Kayıt Oluştur</button>
                    </div>
                </form>
            </div>
            <!--End. Takvim sidebar -->
