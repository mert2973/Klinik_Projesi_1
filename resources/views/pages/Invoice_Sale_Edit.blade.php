        ...
        <div class="page-body">
            ...
            <div class="page-title">
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <h2 class="page-title-text d-inline-block">Invoice Edit</h2>
                        <div class="breadcrumbs d-inline-block">
                            <ul>
                                ...
                                <i class="fa fa-angle-right font-12 ml-2" ></i>
                                <span class="ml-2">Invoice Edit</span>
                            </ul>
                        </div>
                    </div>
            ...
            <form action="http://pepdev.com/theme-preview/klinikal/admin/index.php?route=invoice/edit&amp;id=1" method="post" siq_id="autopick_3612">
                <div class="panel panel-default">
                    ...
                    <input type="hidden" name="invoice[id]" value="1">
                    <input type="hidden" name="invoice[appointment_id]" value="0">
                    <div class="panel-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="invoice[name]" class="form-control patient-name ui-autocomplete-input" value="Pepdev Team" placeholder="Seach Patient Name or Enter . . ." required="" autocomplete="off">
                                        <input type="hidden" name="invoice[patient_id]" class="form-control patient-id" value="7">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="invoice[email]" class="form-control patient-mail" value="support@pepdev.com" placeholder="Enter Patient Email Address . . ." required="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="invoice[mobile]" class="form-control patient-mobile" value="12345567763" placeholder="Enter Patient Mobile No . . .">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="invoice[doctor]" class="form-control patient-doctor ui-autocomplete-input" value="Daniel Barnes" placeholder="Search Doctor . . ." autocomplete="off">
                                        <input type="hidden" name="invoice[doctor_id]" class="form-control patient-doctor-id" value="1">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="invoice[invoicedate]" class="form-control date hasDatepicker" value="07-01-2020" placeholder="Invoice Date" required="" id="dp1582290721781">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i class="ti-calendar"></i></span></div>
                                        <input type="text" name="invoice[duedate]" class="form-control date hasDatepicker" value="03-01-2020" placeholder="Due Date" required="" id="dp1582290721782">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="invoice-items table-responsive pt-3 pb-5">
                            <table class="table-input">
                                ...
                                <tr class="item-row">
                                    <td>
                                        <textarea name="invoice[item][0][name]" class="item-name ui-autocomplete-input" required="" autocomplete="off">Health check up</textarea>
                                    </td>
                                    <td class="invoice-item">
                                        <textarea name="invoice[item][0][descr]" class="item-descr">Body checkup and diagnosis.</textarea>
                                    </td>
                                    <td class="">
                                        <textarea type="text" name="invoice[item][0][quantity]" class="item-quantity" required="">1</textarea>
                                    </td>
                                    <td class="">
                                        <textarea type="text" name="invoice[item][0][cost]" class="item-cost" required="">40.00</textarea>
                                    </td>
                                    <td class="invoice-tax">
                                        <input type="hidden" name="invoice[item][0][taxprice]" class="item-tax-price" value="0.00" readonly="">
                                    </td>
                                    <td>
                                        <textarea type="text" name="invoice[item][0][price]" class="item-total-price" readonly="">40.00</textarea>
                                        <input type="hidden" class="item-price" value="40.00">
                                    </td>
                                    <td>
                                ...
                                <tr class="item-row">
                                    <td>
                                        <textarea name="invoice[item][1][name]" class="item-name ui-autocomplete-input" required="" autocomplete="off">Injection Charges</textarea>
                                    </td>
                                    <td class="invoice-item">
                                        <textarea name="invoice[item][1][descr]" class="item-descr">Injection Charges</textarea>
                                    </td>
                                    <td class="">
                                        <textarea type="text" name="invoice[item][1][quantity]" class="item-quantity" required="">10</textarea>
                                    </td>
                                    <td class="">
                                        <textarea type="text" name="invoice[item][1][cost]" class="item-cost" required="">5.00</textarea>
                                    </td>
                                    <td class="invoice-tax">
                                        <input type="hidden" name="invoice[item][1][taxprice]" class="item-tax-price" value="0.00" readonly="">
                                    </td>
                                    <td>
                                        <textarea type="text" name="invoice[item][1][price]" class="item-total-price" readonly="">50.00</textarea>
                                        <input type="hidden" class="item-price" value="50.00">
                                    </td>
                                    <td>
                                        <a class="badge badge-warning badge-sm badge-pill add-taxes m-1">Add Taxes</a>
                                        <a class="badge badge-danger badge-sm badge-pill delete m-1">Delete</a>
                                ...
                                <tr class="item-row">
                                    <td>
                                        <textarea name="invoice[item][2][name]" class="item-name ui-autocomplete-input" required="" autocomplete="off">Intensive care unit</textarea>
                                    </td>
                                    <td class="invoice-item">
                                        <textarea name="invoice[item][2][descr]" class="item-descr">An intensive care unit or intensive therapy unit or intensive treatment unit or critical care unit</textarea>
                                    </td>
                                    <td class="">
                                        <textarea type="text" name="invoice[item][2][quantity]" class="item-quantity" required="">1</textarea>
                                    </td>
                                    <td class="">
                                        <textarea type="text" name="invoice[item][2][cost]" class="item-cost" required="">46.00</textarea>
                                    </td>
                                    <td class="invoice-tax">
                                        <input type="hidden" name="invoice[item][2][taxprice]" class="item-tax-price" value="0.00" readonly="">
                                    </td>
                                    <td>
                                        <textarea type="text" name="invoice[item][2][price]" class="item-total-price" readonly="">46.00</textarea>
                                        <input type="hidden" class="item-price" value="46.00">
                                    </td>
                                    <td>
                                        <a class="badge badge-warning badge-sm badge-pill add-taxes m-1">Add Taxes</a>
                                        <a class="badge badge-danger badge-sm badge-pill delete m-1">Delete</a>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" class="total-value">
                                        <input type="text" name="invoice[subtotal]" class="form-transparent sub-total" value="136.00" readonly="">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="2" class="total-value">
                                        <input type="text" name="invoice[tax]" class="form-transparent tax-total" value="0.00" readonly="">
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3" class="blank">
                                    ...
                                    <td colspan="2" class="total-value">
                                        <input type="text" name="invoice[discount]" class="form-transparent discount-total" value="10">
                                        <input type="hidden" class="discount_amount" name="invoice[discount_value]" value="13.60">
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3" class="blank">
                                    ...
                                    <td colspan="2" class="total-value">
                                        <input type="text" name="invoice[amount]" class="form-transparent  total-amount" value="122.40" readonly="">
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3" class="blank">
                                    ...
                                    <td colspan="2" class="total-value">
                                        <input type="text" name="invoice[paid]" class="form-transparent paid-amount" value="12.4">
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3" class="blank">
                                    ...
                                    <td colspan="2" class="total-value">
                                        <input type="text" name="invoice[due]" class="form-transparent due-amount" value="110" readonly="">
                                    </td>
                                </tr>
                                </tbody>
                            </table>
