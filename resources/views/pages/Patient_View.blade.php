...
@section('icerik')
                        ...
                        <div class="panel-body">
                            ...
                            <div class="user-details text-center pt-3">
                                ...
                                <ul class="v-menu text-left pt-3 nav d-block">
                                    ...
                                    <li><a href="#patient-process" data-toggle="tab" class=""><i class="ti-files"></i> <span>Yapılan İşlemler</span></a></li>
                ...
                <div class="col-md-8 pl-0">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="patient-invoice">
                            <div class="panel panel-default">
                                <div class="panel-head">
                                    <div class="panel-title">Hasta Faturaları</div>
                                    <div class="panel-action">
                                        ...
                                        <div class="row align-items-center pb-3">
                                            ...
                                            <div class="col-sm-6 text-right">
                                                ...
                                                <table class="table table-middle table-bordered table-striped  no-footer" id="DataTables_Table_1" role="grid" aria-describedby="DataTables_Table_1_info">
                                                    <thead>
                                                    <tr role="row"><th class="sorting" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="ID: activate to sort column ascending" style="width: 0px;">ID</th>
                                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="InvoiceDate: activate to sort column ascending" style="width: 0px;"> Tarihi</th>
                                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending" style="width: 0px;">Durum</th>
                                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Due: activate to sort column ascending" style="width: 0px;">Borç</th>
                                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Due: activate to sort column ascending" style="width: 0px;">Alacak</th>
                                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="InvoiceDate: activate to sort column ascending" style="width: 0px;">Bakiye</th>
                                                        
                                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label=": activate to sort column ascending" style="width: 0px;"></th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                    @foreach($inv_sales_history as $his)
                                                        <tr role="row" class="odd">
                                                            <td>{{$his->inv_sale_id}}</td>
                                                            @if($his->inv_sale_id<10)
                                                                {{"SF-0000"}}{{$his->inv_sale_id}}
                                                            @elseif($his->inv_sale_id<100)
                                                                {{"SF-000"}}{{$his->inv_sale_id}}
                                                            @elseif($his->inv_sale_id<1000)
                                                                {{"SF-00"}}{{$his->inv_sale_id}}
                                                            @elseif($his->inv_sale_id>=10000 || $his->inv_sale_id<=10000)
                                                                {{"SF-"}}{{$his->inv_sale_id}}
                                                            @endif
                                                            <td>{{Carbon\Carbon::parse($his->process_date)->format("d/m/Y")}}</td>
                                                            <td class=" text-info badge-pill badge-sm ">Tahsilat</td>
                                                            <td><span >{{$his->paid}} TL</span></td>
                                                            <td>{{$his->amount_inv}} TL</td>
                                                            <td>{{$his->total_balance}} TL</td>
                                                            <td class="table-action">
                                                                <a href="{{route('Sales_Invoices.show',$his->inv_sale_id)}}" class="text-primary edit" data-toggle="tooltip" title="" target="_blank" data-original-title="View"><i class="ti-layout-media-center-alt"></i></a>
                                                            </td>
                                                        </tr>
                                                   @endforeach
                                                    </tbody>
                        ...
                        <div class="tab-pane fade " id="patient-process">
                            <div class="panel panel-default">
                                <div class="panel-head ">
                                    <div class="row">
                                        <div class="panel-title " style="padding-left:20px">Yapılan İşlemler</div>
                                    </div>
                                    ...
                                    <div class="report-container">
                                        <div class="row">
                                            <div class="col-lg-8 pl-0 ">
                                                <div class="timeline-1 timeline-2">
                                                    <div class="marker"></div>
                                                    @php $lst_appt=""; $arr_tooth=0;  $all_teeth=""; $teeth=[]; @endphp
                                                    @foreach($list_appointment_grpDR_id as $grp_itm)
                                                        <div class="item item-left pt-0">
                                                            <div class="circle">
                                                            ...
                                                            @foreach($list_appointment2 as $lst_appt)
                                                                ...
                                                                @if($grp_itm[0]->doctors_id==$lst_appt->doctors_id)
                                                                    ...
                                                                    <div class="item-content ">
                                                                        <div class="time col-lg-12 " style="left:0px">Dr. {{$lst_appt->name }} {{ $lst_appt->surname }}  <span class="float-right">Randevu Tarihi: {{ $apt_date}}</span></div>
                                                                        <div class="table-responsive pt-2" >
                                                                           
                                                                            <table class="table table-bordered ">
                                                                                <tbody>
                                                                                <tr>
                                                                                    <th style="width: 100px">İşlem Adı</th>
                                                                                    <th style="width: 50px">Adet</th>
                                                                                    <th style="width: 50px">Diş No</th>
                                                                                </tr>
                                                                                
                                                                                @foreach($teeth_processes[$arr_tooth++] as $all_teeth)
                                                                                    <tr>
                                                                                        <td>
                                                                                            <p class="text-primary m-0">{{$all_teeth->prc_name}}</p>
                                                                                            <p class="m-0">{{$all_teeth->exp_prc}}</p>
                                                                                        </td>
                                                                                        <td class="text-center"><p class="font-12">{{$all_teeth->piece}}</p></td>
                                                                                        <td class="text-left"><p class="font-12">{{$all_teeth->teeth_num}}</p></td>
                                                                                        
                                                                                    </tr>
                                                                                    @php
                                                                                    $result="";
                                                                                    if($all_teeth->prc_name=="Köprü"){
                                                                                    $result= str_replace("D","K",$all_teeth->teeth_num);
                                                                                    }else{
                                                                                    $result=  str_replace("D","D",$all_teeth->teeth_num);
                                                                                    }
                                                                                    $teeth[]=explode(",",$result); /*  store all doctors processes */
                                                                                    @endphp
                                                                                @endforeach
                                                                                </tbody>
                                                                            </table>
                                                    ...
                                                    @endforeach
                                                   <!-- get all docotrs process of teeth numbers as array -->
                                                    @php $id=1;// var_dump($teeth) ; @endphp
                                                  
                                                    @foreach($teeth as $a)
                                                        @foreach($a as $b)
                                                            <input type="hidden"  value="{{$b}}" id="tooth_num{{$id++}}">
                                                        @endforeach
                                                    @endforeach
                                                <!--End. get all docotrs process of teeth numbers as array -->
                                                </div>
                                            </div>
                                            <!-- teeth --->
    ...
    <script>
        $(document).ready(function () {
            /**-- sign all teeth on the teeth grafical ---***/
             var num="@php echo $id; @endphp";
             for(var t=1;t<=num;t++){
                var th=$("#tooth_num"+t).val();
               // alert(th);
                 if(th.slice(0,1)=="K"){
                     var a=th.slice(1);
                     $("#Tooth"+a).css("fill","red");
                 }else{
                     var a=th.slice(1);
                     $("#Tooth"+a).css("fill","#e8ea54");
                 }
               
             }
           });
        /**--End.sign all teeth on the teeth grafical ---***/
    </script>
@endsection
