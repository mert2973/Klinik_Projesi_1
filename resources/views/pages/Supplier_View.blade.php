        ...
        <div class="page-body">
            <div class="page-title">
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <h2 class="page-title-text d-inline-block">Tedarik İşlemlerini İncele </h2>
                        <div class="breadcrumbs d-inline-block">
                            <ul>
                                <li><a href="{{url('Dashboard')}}">Dashboard</a></li>
                                <li><a href="{{route('Suppliers.index')}}">Tedarikçiler</a></li>
                                <li>Tedarik İşlemleri</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="user-details text-center pt-3">
                                <h3>{{$supplier->spp_name}}</h3>
                                <ul class="v-menu text-left pt-3 nav d-block">
                                    <li><a href="#medicine-info" class="active" data-toggle="tab"><i class="ti-info-alt"></i> <span>Tedarikçi Bilgileri</span></a></li>
                                    <li><a href="#medicine-stock" data-toggle="tab"><i class="ti-archive"></i> <span>Alış Faturaları</span></a></li>
                                    <li><a href="#medicine-badstock" data-toggle="tab"><i class="ti-files"></i> <span>Bad Stock</span></a></li>
                                    <li><a href="{{""}}"><i class="ti-pencil-alt"></i> <span>Edit</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-8">
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="medicine-info">
                            <div class="panel panel-default">
                                <div class="panel-head">
                                    <div class="panel-title">Tedarikçi Bilgileri</div>
                                </div>
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped patient-table">
                                            ...
                                            <tr>
                                                <td>Tedarikçi Adı</td>
                                                <td>{{$supplier->spp_name}}</td>
                                            </tr>
                                            <tr>
                                                <td>Toplam Alacağı</td>
                                            ...
                                            <tr>
                                                <td>Email Adresi</td>
                                                <td>{{$supplier->spp_email}}</td>
                                            </tr>
                                            <tr>
                                                <td>Telefon Numarası</td>
                                                <td>{{$supplier->spp_phone}}</td>
                                            </tr>
                                            <tr>
                                                <td>Adres</td>
                                                <td>....</td>
                        ...
                        <div class="tab-pane fade" id="medicine-stock">
                            <div class="panel panel-default">
                                <div class="panel-head">
                                    <div class="panel-title">Tedarik İşlem Faturaları</div>
                                </div>
                                <div class="panel-body">
                                        ...
                                        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                            ...
                                            <div class="row"><div class="col-sm-12">
                                                    ...
                                                    <table class="table table-middle table-bordered table-striped " id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                                        <thead>
                                                        <tr role="row"><th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="#: activate to sort column ascending" style="width: 0px;">#</th>
                                                         <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Batch: activate to sort column ascending" style="width: 0px;">Tarih</th>
                                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Expiry: activate to sort column ascending" style="width: 25px;">Açıklama</th>
                                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Purchase Price: activate to sort column ascending" style="width: 0px;">Borç</th>
                                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Purchase Price: activate to sort column ascending" style="width: 0px;">Alacak</th>
                                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Sale Price: activate to sort column ascending" style="width: 0px;">Bakiye</th>
                                                        ...
                                                        <tbody>
                                                        @php $say=1; @endphp
                                                        @foreach($mng_with_payment as $list)
                                                        <tr role="row" class="odd">
                                                            <td>{{$say++}}</td>
                                                            <td class="expiry text-red">{{Carbon\Carbon::parse($list->process_date)->format("d/m/Y")}}</td>
                                                            @if($list->order_mng_id<10)
                                                                <td  class="batch text-primary">{{"F-000".$list->order_mng_id}}</td>
                                                            @elseif($list->order_mng_id<100)
                                                                <td class="batch text-primary">{{"F-00".$list->order_mng_id}}</td>
                                                            @elseif($list->order_mng_id<1000)
                                                                <td class="batch text-primary">{{"F-0".$list->order_mng_id}}</td>
                                                            @elseif($list->order_mng_id>=10000 || $list->order_mng_id<=10000)
                                                                <td class="batch text-primary">{{"F-".$list->order_mng_id}}</td>
                                                                @endif
                                                            <td>{{$list->paid}} TL</td>
                                                            <td>{{$list->amount_inv}} TL</td>
                                                            <td class="qty">{{$list->total_balance}} TL</td>
