...
<div class="page-wrapper">
    <div class="page-body"><div class="page-title">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <h2 class="page-title-text d-inline-block">Edit User Role</h2>
        ...
        <form action="http://pepdev.com/theme-preview/klinikal/admin/index.php?route=role/edit" method="post" enctype="multipart/form-data" siq_id="autopick_5957">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="name" class="form-control" value="Dean" placeholder="Enter User Role Name . . .">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <textarea name="description" class="form-control" rows="3">Clinic's Dean</textarea>
                        </div>
                    </div>
                    <div class="mb-2">
                        ...
                        <table class="table table-bordered table-striped userrole-table table-middle">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="dashboard" value="dashboard" checked="">
                                        <label class="custom-control-label" for="dashboard">Dashboard</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="dashbaordappointment" value="dashbaordappointment" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="patients" value="patients" checked="">
                                        <label class="custom-control-label" for="patients">Patient List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="patient/add" value="patient/add" checked="">
                                        <label class="custom-control-label" for="patient/add">Patient Add</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="patient/edit" value="patient/edit" checked="">
                                        <label class="custom-control-label" for="patient/edit">Patient Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="patient/delete" value="patient/delete" checked="">
                                        <label class="custom-control-label" for="patient/delete">Patient Delete</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="patient/view" value="patient/view" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="patient/notes" value="patient/notes" checked="">
                                        <label class="custom-control-label" for="patient/notes">Patient Clinical Notes</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="patients/documents" value="patients/documents" checked="">
                                        <label class="custom-control-label" for="patients/documents">Paitent Documents</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="patient/sendmail" value="patient/sendmail" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="appointments" value="appointments" checked="">
                                        <label class="custom-control-label" for="appointments">Appointment List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="appointment/add" value="appointment/add" checked="">
                                        <label class="custom-control-label" for="appointment/add">Appointment Add</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="appointment/edit" value="appointment/edit" checked="">
                                        <label class="custom-control-label" for="appointment/edit">Appointment Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="appointment/delete" value="appointment/delete" checked="">
                                        <label class="custom-control-label" for="appointment/delete">Appointment Delete</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="appointment/view" value="appointment/view" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="appointment/sendmail" value="appointment/sendmail" checked="">
                                        <label class="custom-control-label" for="appointment/sendmail">Appointment Sendmail</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="appointment/notes" value="appointment/notes" checked="">
                                        <label class="custom-control-label" for="appointment/notes">Appointment Clinical Notes</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="appointment/documents" value="appointment/documents" checked="">
                                        <label class="custom-control-label" for="appointment/documents">Appointment Documents</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="report/reportUpload" value="report/reportUpload" checked="">
                                        <label class="custom-control-label" for="report/reportUpload">Document Upload</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="report/removeReport" value="report/removeReport" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="prescriptions" value="prescriptions" checked="">
                                        <label class="custom-control-label" for="prescriptions">Prescription List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="prescription/add" value="prescription/add" checked="">
                                        <label class="custom-control-label" for="prescription/add">Prescription Add</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="prescription/edit" value="prescription/edit" checked="">
                                        <label class="custom-control-label" for="prescription/edit">Prescription Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="prescription/delete" value="prescription/delete" checked="">
                                        <label class="custom-control-label" for="prescription/delete">Prescription Delete</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="prescription/view" value="prescription/view" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="prescription/pdf" value="prescription/pdf" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="invoices" value="invoices" checked="">
                                        <label class="custom-control-label" for="invoices">Invoice List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="invoice/add" value="invoice/add" checked="">
                                        <label class="custom-control-label" for="invoice/add">Invoice Add</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="invoice/edit" value="invoice/edit" checked="">
                                        <label class="custom-control-label" for="invoice/edit">Invoice Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="invoice/delete" value="invoice/delete" checked="">
                                        <label class="custom-control-label" for="invoice/delete">Invoice Delete</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="invoice/view" value="invoice/view" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="invoice/pdf" value="invoice/pdf" checked="">
                                        <label class="custom-control-label" for="invoice/pdf">Invoice PDF</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="invoice/sentmail" value="invoice/sentmail" checked="">
                                        <label class="custom-control-label" for="invoice/sentmail">Invoice Sendmail</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="addpayment" value="addpayment" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="request" value="request" checked="">
                                        <label class="custom-control-label" for="request">Request List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="request/edit" value="request/edit" checked="">
                                        <label class="custom-control-label" for="request/edit">Request Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="request/delete" value="request/delete" checked="">
                                        <label class="custom-control-label" for="request/delete">Request Delete</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="request/view" value="request/view" checked="">
                                        <label class="custom-control-label" for="request/view">Request View</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="request/mail" value="request/mail" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="medicines" value="medicines" checked="">
                                        <label class="custom-control-label" for="medicines">Medicine List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="medicine/add" value="medicine/add" checked="">
                                        <label class="custom-control-label" for="medicine/add">Medicine Add</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="medicine/edit" value="medicine/edit" checked="">
                                        <label class="custom-control-label" for="medicine/edit">Medicine Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="medicine/delete" value="medicine/delete" checked="">
                                        <label class="custom-control-label" for="medicine/delete">Medicine Delete</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="medicine/view" value="medicine/view" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="medicine/upload" value="medicine/upload" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="departments" value="departments" checked="">
                                        <label class="custom-control-label" for="departments">Department List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="department/add" value="department/add" checked="">
                                        <label class="custom-control-label" for="department/add">Department Add</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="department/edit" value="department/edit" checked="">
                                        <label class="custom-control-label" for="department/edit">Department Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="department/delete" value="department/delete" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="doctors" value="doctors" checked="">
                                        <label class="custom-control-label" for="doctors">Doctor List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="doctor/add" value="doctor/add" checked="">
                                        <label class="custom-control-label" for="doctor/add">Doctor Add</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="doctor/edit" value="doctor/edit" checked="">
                                        <label class="custom-control-label" for="doctor/edit">Doctor Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="doctor/delete" value="doctor/delete" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="expenses" value="expenses" checked="">
                                        <label class="custom-control-label" for="expenses">Expense List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="expense/add" value="expense/add" checked="">
                                        <label class="custom-control-label" for="expense/add">Expense Add</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="expense/edit" value="expense/edit" checked="">
                                        <label class="custom-control-label" for="expense/edit">Expense Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="expense/delete" value="expense/delete" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="expensetype" value="expensetype" checked="">
                                        <label class="custom-control-label" for="expensetype">Expenses Type List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="expensetype/add" value="expensetype/add" checked="">
                                        <label class="custom-control-label" for="expensetype/add">Expenses Type Add</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="expensetype/edit" value="expensetype/edit" checked="">
                                        <label class="custom-control-label" for="expensetype/edit">Expenses Type Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="expensetype/delete" value="expensetype/delete" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="staffattendance" value="staffattendance" checked="">
                                        <label class="custom-control-label" for="staffattendance">Attendance List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="staffattendance/add" value="staffattendance/add" checked="">
                                        <label class="custom-control-label" for="staffattendance/add">Attendance Add</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="staffattendance/view" value="staffattendance/view" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="salarytemplate" value="salarytemplate" checked="">
                                        <label class="custom-control-label" for="salarytemplate">Salary Template List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="salarytemplate/add" value="salarytemplate/add" checked="">
                                        <label class="custom-control-label" for="salarytemplate/add">Salary Template Add</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="salarytemplate/edit" value="salarytemplate/edit" checked="">
                                        <label class="custom-control-label" for="salarytemplate/edit">Salary Template Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="salarytemplate/delete" value="salarytemplate/delete" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="managesalary" value="managesalary" checked="">
                                        <label class="custom-control-label" for="managesalary">Manage Salary List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="managesalary/add" value="managesalary/add" checked="">
                                        <label class="custom-control-label" for="managesalary/add">Manage Salary Add</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="managesalary/edit" value="managesalary/edit" checked="">
                                        <label class="custom-control-label" for="managesalary/edit">Manage Salary Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="managesalary/view" value="managesalary/view" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="makepayment" value="makepayment" checked="">
                                        <label class="custom-control-label" for="makepayment">Make payment List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="makepayment/add" value="makepayment/add" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="birthrecords" value="birthrecords" checked="">
                                        <label class="custom-control-label" for="birthrecords">Birthrecords List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="birthrecord/add" value="birthrecord/add" checked="">
                                        <label class="custom-control-label" for="birthrecord/add">Birthrecord Add</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="birthrecord/edit" value="birthrecord/edit" checked="">
                                        <label class="custom-control-label" for="birthrecord/edit">Birthrecord Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="birthrecord/delete" value="birthrecord/delete" checked="">
                                        <label class="custom-control-label" for="birthrecord/delete">Birthrecord Delete</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="birthrecord/view" value="birthrecord/view" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="birthrecord/pdf" value="birthrecord/pdf" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="deathrecords" value="deathrecords" checked="">
                                        <label class="custom-control-label" for="deathrecords">Deathrecords List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="deathrecord/add" value="deathrecord/add" checked="">
                                        <label class="custom-control-label" for="deathrecord/add">Deathrecord Add</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="deathrecord/edit" value="deathrecord/edit" checked="">
                                        <label class="custom-control-label" for="deathrecord/edit">Deathrecord Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="deathrecord/delete" value="deathrecord/delete" checked="">
                                        <label class="custom-control-label" for="deathrecord/delete">Deathrecord Delete</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="deathrecord/view" value="deathrecord/view" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="deathrecord/pdf" value="deathrecord/pdf" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="noticeboard" value="noticeboard" checked="">
                                        <label class="custom-control-label" for="noticeboard">Noticeboard List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="noticeboard/add" value="noticeboard/add" checked="">
                                        <label class="custom-control-label" for="noticeboard/add">Noticeboard Add</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="noticeboard/edit" value="noticeboard/edit" checked="">
                                        <label class="custom-control-label" for="noticeboard/edit">Noticeboard Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="noticeboard/delete" value="noticeboard/delete" checked="">
                                        <label class="custom-control-label" for="noticeboard/delete">Noticeboard Delete</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="noticeboard/view" value="noticeboard/view" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="users" value="users" checked="">
                                        <label class="custom-control-label" for="users">User List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="user/add" value="user/add" checked="">
                                        <label class="custom-control-label" for="user/add">User Add</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="user/edit" value="user/edit" checked="">
                                        <label class="custom-control-label" for="user/edit">User Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="user/delete" value="user/delete" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="subscribers" value="subscribers" checked="">
                                        <label class="custom-control-label" for="subscribers">Subscriber List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="subscriber/add" value="subscriber/add" checked="">
                                        <label class="custom-control-label" for="subscriber/add">Subscriber Add</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="subscriber/edit" value="subscriber/edit" checked="">
                                        <label class="custom-control-label" for="subscriber/edit">Subscriber Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="subscriber/delete" value="subscriber/delete" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="facility" value="facility" checked="">
                                        <label class="custom-control-label" for="facility">Facility List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="facility/add" value="facility/add" checked="">
                                        <label class="custom-control-label" for="facility/add">Facility Add</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="facility/edit" value="facility/edit" checked="">
                                        <label class="custom-control-label" for="facility/edit">Facility Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="facility/delete" value="facility/delete" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="services" value="services" checked="">
                                        <label class="custom-control-label" for="services">Service List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="service/add" value="service/add" checked="">
                                        <label class="custom-control-label" for="service/add">Service Add</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="service/edit" value="service/edit" checked="">
                                        <label class="custom-control-label" for="service/edit">Service Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="service/delete" value="service/delete" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="reviews" value="reviews" checked="">
                                        <label class="custom-control-label" for="reviews">Review List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="review/edit" value="review/edit" checked="">
                                        <label class="custom-control-label" for="review/edit">Review Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="review/delete" value="review/delete" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="testimonials" value="testimonials" checked="">
                                        <label class="custom-control-label" for="testimonials">Testimonial List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="testimonial/add" value="testimonial/add" checked="">
                                        <label class="custom-control-label" for="testimonial/add">Testimonial Add</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="testimonial/edit" value="testimonial/edit" checked="">
                                        <label class="custom-control-label" for="testimonial/edit">Testimonial Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="testimonial/delete" value="testimonial/delete" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="blogs" value="blogs" checked="">
                                        <label class="custom-control-label" for="blogs">Blog List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="blog/add" value="blog/add" checked="">
                                        <label class="custom-control-label" for="blog/add">Blog Add</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="blog/edit" value="blog/edit" checked="">
                                        <label class="custom-control-label" for="blog/edit">Blog Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="blog/delete" value="blog/delete" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="category" value="category" checked="">
                                        <label class="custom-control-label" for="category">Category List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="category/add" value="category/add" checked="">
                                        <label class="custom-control-label" for="category/add">Category Add</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="category/edit" value="category/edit" checked="">
                                        <label class="custom-control-label" for="category/edit">Category Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="category/delete" value="category/delete" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="comment" value="comment" checked="">
                                        <label class="custom-control-label" for="comment">Comment List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="comment/edit" value="comment/edit" checked="">
                                        <label class="custom-control-label" for="comment/edit">Comment Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="comment/delete" value="comment/delete" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="notes" value="notes" checked="">
                                        <label class="custom-control-label" for="notes">Clinical Notes List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="note/add" value="note/add" checked="">
                                        <label class="custom-control-label" for="note/add">Clinical Note Add</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="note/edit" value="note/edit" checked="">
                                        <label class="custom-control-label" for="note/edit">Clinical Note Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="note/delete" value="note/delete" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="items" value="items" checked="">
                                        <label class="custom-control-label" for="items">Items List</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="item/add" value="item/add" checked="">
                                        <label class="custom-control-label" for="item/add">Items Add</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="item/edit" value="item/edit" checked="">
                                        <label class="custom-control-label" for="item/edit">Items Edit</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="item/delete" value="item/delete" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="send/email" value="send/email" checked="">
                                        <label class="custom-control-label" for="send/email">Send Email</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="sendbulk/email" value="sendbulk/email" checked="">
                                        <label class="custom-control-label" for="sendbulk/email">Send Bulk Email</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="emaillogs" value="emaillogs" checked="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="get/media" value="get/media" checked="">
                                        <label class="custom-control-label" for="get/media">Media on Modal</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="media/upload" value="media/upload" checked="">
                                        <label class="custom-control-label" for="media/upload">Media Upload</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="role[]" id="media/delete" value="media/delete" checked="">
