                                            ...
                                            <table class="table table-bordered medicine-table " >
                                                ...
                                                @foreach($teeth_processes as $itm)
                                                    <tr class="">
                                                        ...
                                                        <td>
                                                            <input class="form-control proceses_name" name=tooth_record[{{$say}}][name]" value="{{$itm->prc_name}}" placeholder="İşlem adı">
                                                            <input type="hidden" class="itm_id"  name=tooth_record[{{$say}}][itm_id]" value="{{$itm->id}}">
                                                        </td>
                                                        <td>
                                                            <input type="number" class="form-control " name=tooth_record[{{$say}}][piece]" value="{{$itm->piece}}" placeholder="Adet">
                                                        </td>
                                                        <td>
                                                            <textarea class="form-control proceses_exp" name=tooth_record[{{$say}}][exp]" {{$itm->exp_prc}} placeholder="Adet">{{$itm->exp_prc}}</textarea>
                                                        </td>
                                                        <td>
                                                            <input type="text" class="form-control tooth_click{{$say}}" name=tooth_record[{{$say}}][tooth]" value="{{$itm->teeth_num}}"  placeholder="Diş Numarası" id="teeth_num<?php teeth_num_fnc(1); ?>">
                                                        </td>
                                                        <td><button class="table-action-button medicine-delete" value="{{$say}}" style="display: none;" id="del_row<?php del_row_fnc(1); ?>"><i class="ti-trash text-danger"></i></button></td>
                                                    </tr>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(".prc_click").click(function () {
                var b="@php echo $say; @endphp";
                for(var r=0;r<=b;r++){
                    $(".tooth_click"+r).click();
                    $(".tooth_click"+r).focusout();
                }
            });
            /** ---End.when click yapılan işlemler **/
            
            var cnt="@php function teeth_num_fnc($id){ return $id; } @endphp";
            var del="@php function del_row_fnc($id){ return $id; } @endphp";
        
            /**** Coculation of Tooth ****/
            $("#teeth_num,cnt").keydown(function () {
                if($(this).val().startsWith("D")==false){
                    $(this).val("D");
                }
            });
            $("#teeth_num,cnt").keyup(function () {
            ...
            $("#teeth_num,cnt").focusout(function () {
